...
var loadRooms = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, rooms_model_cjs_1.default.find().sort({ position: 1 }).exec()];
}); }); };
exports.loadRooms = loadRooms;
var getVoiceRooms = function () { return __awaiter(void 0, void 0, void 0, function () {
    var voices;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                voices = {};
                return [4 /*yield*/, rooms_model_cjs_1.default.find({ voice: true })
                        .exec()
                        .then(function (doc) {
                        doc.map(function (el) {
            ...
            case 1:
                _a.sent();
                return [2 /*return*/, voices];
        }
    });
}); };
exports.getVoiceRooms = getVoiceRooms;
var findLowestPositionRoom = function () {
